...
/** @type {__VLS_StyleScopedClasses['bg-[radial-gradient(circle_at_top,rgba(22,143,232,0.10),transparent_42%)]']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({
    ...{ class: "mb-2 text-sm font-semibold tracking-wide text-sky-600" },
});
...
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({
    ...{ class: "mx-auto mt-3 max-w-sm text-sm leading-6 text-slate-500 sm:text-base" },
});
/** @type {__VLS_StyleScopedClasses['mx-auto']} */ ;
...
/** @type {__VLS_StyleScopedClasses['rounded-[1.75rem]']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-slate-200/80']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-white']} */ ;
/** @type {__VLS_StyleScopedClasses['p-6']} */ ;
/** @type {__VLS_StyleScopedClasses['shadow-(--syner-shadow-card)']} */ ;
/** @type {__VLS_StyleScopedClasses['sm:p-8']} */ ;
const __VLS_6 = RegisterForm;
// @ts-ignore
const __VLS_7 = __VLS_asFunctionalComponent1(__VLS_6, new __VLS_6({}));
const __VLS_8 = __VLS_7({}, ...__VLS_functionalComponentArgsRest(__VLS_7));
__VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({
    ...{ class: "mt-6 text-center text-xs leading-5 text-slate-400" },
});
